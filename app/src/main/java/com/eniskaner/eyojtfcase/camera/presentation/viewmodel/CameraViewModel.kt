package com.eniskaner.eyojtfcase.camera.presentation.viewmodel
...
class CameraViewModel @Inject constructor(
    ...
    private val _updateSugarBeetCount = MutableLiveData<CameraUIState<String>>()
    val updateSugarBeetCount: LiveData<CameraUIState<String>>
        get() = _updateSugarBeetCount

    fun updateSugarBeetCount() {
        _updateSugarBeetCount.value = CameraUIState.Loading
        cameraRepository.updateSugarBeetCountOnFireBase(numberOfSugarbeets) {
